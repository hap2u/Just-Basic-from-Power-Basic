...
Noticed from past methods, that placing spaces arround all operators and definers, improved the search and replacement of old code.
...
So if one discouvered B needed to be done before A, it was easy using cut and paste to make this change.
